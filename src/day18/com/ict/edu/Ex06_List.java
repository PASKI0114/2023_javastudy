...
public class Ex06_List {
	...
	//add(index, E) => 삽입 (중간에 끼어드는것)
	//pop : 맨위에 존재하는 객체를 반환하고 삭제한다.
	//peek : 맨위에 존재하는 객체 반환, 삭제안함.
	...
	public static void main(String[] args) {
		...
		if(stack.contains("둘리")) {
			//둘리위치찾기
			System.out.println(stack.indexOf("둘리"));//(오른쪽, 1부터)
			System.out.println(stack.search("둘리"));//(왼쪽, 0부터)
