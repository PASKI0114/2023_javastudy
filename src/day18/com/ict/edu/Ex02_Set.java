...
public class Ex02_Set {
	public static void main(String[] args) {
		...
		h3.add('a');
		h3.add('v');
		h3.add('a'); //중복불가. 들어가지않음.
		System.out.println(h3);
		System.out.println();
		
		System.out.println("하나씩 처리하기 (개선된 for문)");
		for (Integer k : h1) {
			System.out.println(k); //언박싱
		}
		System.out.println();
		
		System.out.println("하나씩 처리하기 (interater)");
